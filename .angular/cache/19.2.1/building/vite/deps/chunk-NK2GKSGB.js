import {
  AppCheckInstances
} from "./chunk-MZY3W3QV.js";
import {
  isPlatformServer
} from "./chunk-GLAS3TAC.js";
import {
  FIREBASE_APP_NAME,
  FIREBASE_OPTIONS,
  ɵapplyMixins,
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-MBH2AZAP.js";
import {
  firebase
} from "./chunk-BK4CQVBC.js";
import {
  VERSION,
  pendingUntilEvent,
  ɵAngularFireSchedulers
} from "./chunk-WF5XCJJP.js";
import {
  EnvironmentInjector,
  Inject,
  Injectable,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-SHXFHDGO.js"))), map(() => ɵfirebaseAppFactory(options, zone, name)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
...
//# sourceMappingURL=chunk-NK2GKSGB.js.map
